...
class UserVacancyController extends Controller
{
    ...
    $Vid= $id->id;
        ...
        $data = DB::table('vacancies')
            ...
            ->select('admins.c_name','admins.email','admins.c_phone','admins.c_city','vacancies.title','vacancies.position','vacancies.image','vacancies.description','vacancies.q1','vacancies.q2','vacancies.q3','vacancies.q4')
