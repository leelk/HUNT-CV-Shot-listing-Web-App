...
<header class="header-area main-header">
    <div class="container">
        <div class="row">
            <div class="col-lg-2">
                <div class="logo-area">
                    <a href="index.html"><img src="{{asset('assets')}}/images/logo.png" alt="logo" style="width: 120px;height: 120px;"></a>
                </div>
            </div>
            <div class="col-lg-10">
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="https://goo.gl/MbZdFm" alt="First slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="https://goo.gl/MbZdFm" alt="Second slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="https://goo.gl/MbZdFm" alt="Third slide">
        </div>
    </div>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="recent" role="tabpanel" aria-labelledby="home-tab">
                        <div class="single-job mb-4 d-lg-flex justify-content-between">
                            ...
                            <div class="job-img align-self-center">
                                <img src="{{asset('assets')}}/images/job1.png" alt="job">
                            </div>
                    ...
                    <div class="tab-pane fade" id="full-time" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="single-job mb-4 d-lg-flex justify-content-between">
                            ...
                            <div class="job-img align-self-center">
                                <img src="{{asset('assets')}}/images/job2.png" alt="job">
                            </div>
                            <div class="job-btn align-self-center">
                    ...
                    <div class="tab-pane fade" id="part-time" role="tabpanel" aria-labelledby="contact-tab">
                        <div class="single-job mb-4 d-lg-flex justify-content-between">
                            ...
                            <div class="job-img align-self-center">
                                <img src="{{asset('assets')}}/images/job3.png" alt="job">
                            </div>
                            <div class="job-btn align-self-center">
                    ...
                    <div class="tab-pane fade" id="intern" role="tabpanel" aria-labelledby="contact-tab2s">
                        <div class="single-job mb-4 d-lg-flex justify-content-between">
                            ...
                            <div class="job-img align-self-center">
                                <img src="{{asset('assets')}}/images/job4.png" alt="job">
                            </div>
                            <div class="job-btn align-self-center">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 offset-xl-1 col-lg-3">
                    <div class="single-widge-home">
                        ...
                        <div class="feed">
                            <img src="{{asset('assets')}}/assets/images/feed1.jpg" alt="feed">
                            <img src="{{asset('assets')}}/assets/images/feed2.jpg" alt="feed">
                            <img src="{{asset('assets')}}/assets/images/feed3.jpg" alt="feed">
                            <img src="{{asset('assets')}}/assets/images/feed4.jpg" alt="feed">
                            <img src="{{asset('assets')}}/assets/images/feed5.jpg" alt="feed">
                            <img src="{{asset('assets')}}/assets/images/feed6.jpg" alt="feed">
                            <img src="{{asset('assets')}}/assets/images/feed7.jpg" alt="feed">
                            <img src="{{asset('assets')}}/assets/images/feed8.jpg" alt="feed">
                        </div>
                    </div>
                </div>
            </div>
...
<script src="{{asset('assets')}}/js/vendor/ion.rangeSlider.js"></script>
